...
### Module Information
```
Module Path: github.com/TIBCOSoftware/flogo-enterprise-hub/extensions/prometheus-metrics
...
```bash
flogo install github.com/TIBCOSoftware/flogo-enterprise-hub/extensions/prometheus-metrics
```
...
{
  "imports": [
    "github.com/TIBCOSoftware/flogo-enterprise-hub/extensions/prometheus-metrics"
  ]
}
```
...
{
  "activity": {
    "ref": "github.com/TIBCOSoftware/flogo-enterprise-hub/extensions/prometheus-metrics",
    "settings": {
      "metricType": "gauge",
